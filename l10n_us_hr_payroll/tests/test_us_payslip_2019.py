...
class TestUsPayslip2019(TestUsPayslip):
    ...
    def test_2019_fed_income_withholding_single(self):
        ...
        adjusted_salary = salary - w4_allowance_amt
        ###
    ...
    def test_2019_fed_income_withholding_nonresident_alien(self):
        ...
        w4_allowances = 1
        w4_allowance_amt = 1050.00 * w4_allowances
        nra_adjustment = 2000.00  # for quarterly
    ...
    def test_2019_fed_income_additional_withholding(self):
        ...
        w4_allowances = 2
        w4_allowance_amt = 4200.00 * w4_allowances
        adjusted_salary = salary - w4_allowance_amt  # 41600
